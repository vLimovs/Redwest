...
const MediaSection = () => {
    return (
        <section className="media__section my-container text-white my-[50px]">
            <h2 className="title text-center font-[montserrat] font-bold text-[44px] mb-[54px]">МЕДИА РАЗДЕЛ</h2>
            <div className="flex items-center justify-between gap-[95px] w-full">
                ...
                <article style={{
                    ...
                    <h4 className="font-[montserrat] font-bold text-[25px] text-cen text-center">Новая публикация</h4>
